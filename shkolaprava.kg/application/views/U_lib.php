...
<body>
  ...
  <nav id="desktop_navbar">
    ...
    <ul>
      ...
      <li><a href="<?php echo base_url()?>analytics" class="active1" style="font-weight: 600;">Аналитика</a></li>
		...
		<div class="panel relative">
			<div class="forum-head" style="background-image: url(<?php echo base_url()?>images/bg-forum.jpg);">
				<div class="centered-text">
					<h1 class="text-center text-uppercase display-3 font-weight-bold" style="background: #ff0000bf;">Библиотека</h1>
				</div>
			</div>
		</div>
		<div class="container mt-5">
                <div class="input-group mb-3">
                    ...
                    <div class="input-group-append">
                        <button class="btn btn-outline-primary pr-5 pl-5">
                    ...
                    <table class="table table-hover pill-border">
						<thead>
							<tr>
								<th scope="col" style="background-color: #ff0000; color: white"><i class="fa fa-2x fa-file-pdf-o mr-2" aria-hidden="true"></i>Название категории</th>
							</tr>
						</thead>
						<tbody>
							...
							<tr>
								<th scope="row">
									<a class="mt-2" href="<?php echo base_url()?>pdf_files/<?php echo $row['route']?>"><?php echo $row['name']?></a>
								</th>
							</tr>
        					<?php }?>
						</tbody>
