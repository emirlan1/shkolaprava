...
<body>
  ...
  <nav id="desktop_navbar">
    ...
    <ul>
      ...
      <li><a href="<?php echo base_url()?>projects" class="active1" style="font-weight: 600;">Наша деятельность</a></li>
    </ul>
  </div>
  </nav>
	<!-- Page Container -->
		...
		<div class="panel relative">
			<div class="forum-head" style="background-image: url(<?php echo base_url()?>images/bg-forum.jpg);">
				<div class="centered-text">
					<h1 class="text-center text-uppercase display-3 font-weight-bold" style="background: #ff0000bf;">Юристы</h1>
				</div>
			</div>
		</div>
                ...
                <?php foreach($lib as $row){ ?>
                    <div class="col">
                        <a href="#" class="link-reset">
                            <div class="card">
                                <img src="<?php echo base_url()?>uploads/<?php echo $row['img']?>" class="card-img-top card-img" alt="">
                                <div class="card-body">
                                   <h4 class="card-title font-weight-bold"><?php echo $row['name']?></h4>
                                    <p class="card-text"><?php echo $row['text']?></p>
                                    <p class="card-text mt-4 text-muted"><?php echo date('Y-m-d',$row['date'])?></p>
                                </div>
                            </div>
                        </a>
                    </div>
