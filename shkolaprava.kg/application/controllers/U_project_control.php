...
class U_project_control extends CI_Controller {
    ...
    public function projects() {
        $this->load->model('U_project_model');
        $lib = $this->U_project_model->getProjects()->result_array();

        $data = array(
            'lib' => $lib,
            //'csrf_hash' => $this->security->get_csrf_hash(),
        );
        $this->load->view('u_project_view', $data);
    }
