...
class Reports extends CI_Controller {
    ...
    public function One_report($report_id) {
        $one_report = array (
            ...
            'report_img' => $this->report_images_model->getReportImagesByReportId($report_id),
            'csrf_hash' => $this->security->get_csrf_hash(),
            "report_id" => $report_id
        );
        $this->load->view('one_report', $one_report);
    }
    public function insert_report_img(){
        $id = $this->input->post('id');
        echo $this->report_images_model->insertReportImage($id);
    }
    public function delete_report_img(){
        $id = $this->input->post('id');
        echo $this->report_images_model->deleteReportImageById($id);
    }
